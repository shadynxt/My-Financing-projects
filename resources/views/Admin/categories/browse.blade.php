...
<section class="content-header">
    <h1>
       {{ Html::linkAction('Admin\AdminController@dashboard', 'لوحه التحكم', '', []) }}
        <small> {{ Html::linkAction('Admin\CategoryController@index', 'كل الفئات', '', []) }} {{ count($categories) }}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">كل الفئات</h3>
                  </div><!-- /.box-header -->
                  <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                      <thead>
                        ...
                        <tbody>
                            ...
                            <td>
                                {{ Html::linkAction('Admin\CategoryController@edit', 'تعديل', array('id' => $category->id ), array('class' => 'btn btn-info btn btn-small ')) }}
