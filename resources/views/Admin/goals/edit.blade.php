...
<section class="content">
    <center>
        <div style="width:500px; ">
            {{ Form::open(array('route' => array('goal.update',$goal->id),'enctype' => 'multipart/form-data','method' => 'PUT','class'=>'form-horizontal')) }}
            <div class="box-body">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">العنوان</label>

                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" id="inputPassword3" value="{{ $goal->title }}">
                        @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="body" class="form-control" id="inputEmail3" value="{{ $goal->body }}">
                        @if ($errors->has('body'))
            ...
            <div class="form-group">
                 <label for="inputPassword3" class="col-sm-2 control-label">صوره الهدف </label>

                  <div class="col-sm-10">
                      {{ Html::image('public/uploads/projects/'.$goal->img, 'a picture', array('width'=>'200','height'=>'150')) }}
                      {!! Form::file('img') !!}
                      @if ($errors->has('img'))
